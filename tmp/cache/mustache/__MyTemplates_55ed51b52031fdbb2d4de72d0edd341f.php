...
class __MyTemplates_55ed51b52031fdbb2d4de72d0edd341f extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section1aebf777e3f9eea92a14193a789e7bd9($context, $indent, $value);
        $buffer .= $indent . '  </div>
';
        $buffer .= $indent . '</main>
';
    ...
    private function section1aebf777e3f9eea92a14193a789e7bd9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
