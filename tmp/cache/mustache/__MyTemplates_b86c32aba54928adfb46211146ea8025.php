...
class __MyTemplates_b86c32aba54928adfb46211146ea8025 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionE6c5033a830a7e7ec5f4bc93857e0a93($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function sectionD62ce0a2aff8253ce7118905f2df5213(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section87963b70deed695e7a225d4c2c36f5e5(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function sectionE6c5033a830a7e7ec5f4bc93857e0a93(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                ...
                $buffer .= $this->sectionD62ce0a2aff8253ce7118905f2df5213($context, $indent, $value);
                $buffer .= $indent . '            </div>
';
                $buffer .= $indent . '            <div class="stars empty">
';
                $value = $context->find('stars');
                $buffer .= $this->section87963b70deed695e7a225d4c2c36f5e5($context, $indent, $value);
                $buffer .= $indent . '            </div>
';
                $buffer .= $indent . '          </div>
';
