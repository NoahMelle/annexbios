...
class __MyTemplates_4eef52de1dbc57bf8ef9591c48846c26 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionC59d1b09790a086142b9bd4cfc971c50($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</main>
';
...
';
    ...
    private function sectionC59d1b09790a086142b9bd4cfc971c50(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="playing-movie skeleton">
        ...
        <div class="rm-details">
          ...
          <div class="rm-play-time skeleton"></div>
          <div class="rm-places-available skeleton"></div>
        </div>
      </div>
      ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '          <div class="rm-play-time skeleton"></div>
';
                $buffer .= $indent . '          <div class="rm-places-available skeleton"></div>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '      </div>
