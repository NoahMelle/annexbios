...
class __MyTemplates_83d50727d0e86f33d2b484244d59752e extends Mustache_Template
{
...
';
        ...
        $buffer .= 'cms/vestigingen/toevoegen" class="hero-view-locations">
';
...
';
        ...
        $buffer .= $this->section0fbfc1ca362a6e8ac614357a474a6ad9($context, $indent, $value);
        $buffer .= $indent . '  </div>
';
        $buffer .= $indent . '</main>
';
    ...
    private function section0fbfc1ca362a6e8ac614357a474a6ad9(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="location">
      <div class="location-info">
        ...
        <a href="{{ base_url }}cms/vestigingen/wijzig/{{ location_id }}" class="location-button">Wijzig Vesteging</a>
        <a href="{{ base_url }}cms/vestigingen/verwijder/{{ location_id }}" class="location-button red">Verwijder
          Vesteging</a>
      </div>
    </div>
    ';
