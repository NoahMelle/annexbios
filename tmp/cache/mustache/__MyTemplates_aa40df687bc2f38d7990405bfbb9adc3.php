...
class __MyTemplates_aa40df687bc2f38d7990405bfbb9adc3 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionA8b55a4fc44bd1b8e19197e3471a9212($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</main>
';
...
';
    ...
    private function sectionA8b55a4fc44bd1b8e19197e3471a9212(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="playing-movie skeleton">
        ...
        <div class="rm-cms">
          <a href="{{ base_url }}filmladder/bewerken/{{ id }}" class="rm-edit">BEWERK</a>
          <a href="{{ base_url }}filmladder/verwijderen/{{ id }}" class="rm-delete">VERWIJDER</a>
        </div>
      </div>
      ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                ...
                $value = $this->resolveValue($context->find('base_url'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= 'filmladder/bewerken/';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '" class="rm-edit">BEWERK</a>
';
                $buffer .= $indent . '          <a href="';
                $value = $this->resolveValue($context->find('base_url'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= 'filmladder/verwijderen/';
                $value = $this->resolveValue($context->find('id'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '" class="rm-delete">VERWIJDER</a>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '      </div>
