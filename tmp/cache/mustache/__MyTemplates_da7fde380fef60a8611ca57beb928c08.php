...
class __MyTemplates_da7fde380fef60a8611ca57beb928c08 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section15f7600f1e0b77cfd986ef122ca30a09($context, $indent, $value);
        $buffer .= $indent . '  </div>
';
        $buffer .= $indent . '</main>
';
    ...
    private function section15f7600f1e0b77cfd986ef122ca30a09(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="location">
      ...
      <div class="location-info">
        ...
        <a href="#" class="location-button">Verwijder Vesteging</a>
...
';
                $buffer .= $indent . '        <a href="#" class="location-button">Verwijder Vesteging</a>
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '      </div>
