...
class __MyTemplates_46cb1254efd8471684ba1422a3e396bb extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionAd3d65da2f3ea517059d8a1b09ec268a($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function sectionAd3d65da2f3ea517059d8a1b09ec268a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="recommended-movie">
                        ...
                        <div class="rm-details">
                            <div class="rm-title skeleton">testestest testestest testestest testestest</div>
...
';
                $buffer .= $indent . '                            <div class="rm-title skeleton">testestest testestest testestest testestest</div>
';
