...
class __MyTemplates_4b3cbc89e2327db90402a4ab17d9323b extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section5589c0dac89d15be6802ffb5f796c48c($context, $indent, $value);
...
';
    ...
    private function section5589c0dac89d15be6802ffb5f796c48c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (is_object($value) && is_callable($value)) {
            $source = '
        <option value="{{ function_id }}">{{ function }}</option>
        ';
