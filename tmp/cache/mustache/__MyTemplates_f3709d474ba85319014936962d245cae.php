...
class __MyTemplates_f3709d474ba85319014936962d245cae extends Mustache_Template
{
...
';
        ...
        $buffer .= 'cms/filmladder/toevoegen" class="hero-view-locations">
';
...
';
        ...
        $buffer .= $this->section68f5648d612dcf24390deb314510f694($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</main>
';
...
';
    ...
    private function section68f5648d612dcf24390deb314510f694(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="playing-movie skeleton">
        ...
        <div class="rm-cms">
          <a href="{{ base_url }}cms/filmladder/wijzig/" class="rm-edit">BEWERK</a>
          <a href="{{ base_url }}cms/filmladder/verwijder/" class="rm-delete">VERWIJDER</a>
        </div>
      </div>
      ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                ...
                $value = $this->resolveValue($context->find('base_url'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= 'cms/filmladder/wijzig/" class="rm-edit">BEWERK</a>
';
                $buffer .= $indent . '          <a href="';
                $value = $this->resolveValue($context->find('base_url'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= 'cms/filmladder/verwijder/" class="rm-delete">VERWIJDER</a>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '      </div>
