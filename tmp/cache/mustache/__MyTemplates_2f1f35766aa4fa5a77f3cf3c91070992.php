...
class __MyTemplates_2f1f35766aa4fa5a77f3cf3c91070992 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD44f0d54cace4efef8f08137ccd069ca($context, $indent, $value);
...
';
    ...
    private function sectionD44f0d54cace4efef8f08137ccd069ca(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    
        if (is_object($value) && is_callable($value)) {
            $source = '
        <option value="{{ function_id }}">{{ function_name }}</option>
        ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '">';
                $value = $this->resolveValue($context->find('function_name'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= '</option>
';
                $context->pop();
