...
class __MyTemplates_3a7bc31e8ae9faaf9b8d1aa03eb03cf7 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section2e719b99669957729c6a11c87a83af1d($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function section2e719b99669957729c6a11c87a83af1d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="recommended-movie">
        <div class="rm-img-container skeleton">
        </div>
...
';
                $buffer .= $indent . '        <div class="rm-img-container skeleton">
';
                $buffer .= $indent . '        </div>
';
...
';
                $buffer .= $indent . '            <div class="empty-stars"></div>
';
                $buffer .= $indent . '            <div class="full-stars" style="width:70%"></div>
';
                $buffer .= $indent . '          </div>
';
