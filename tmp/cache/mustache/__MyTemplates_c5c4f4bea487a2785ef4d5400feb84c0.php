...
class __MyTemplates_c5c4f4bea487a2785ef4d5400feb84c0 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section677c67d66f55fb243924a747198ea095($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function section9395a8516155485c6c8daa86428125ac(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    private function section677c67d66f55fb243924a747198ea095(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $value = $context->find('stars');
                $buffer .= $this->section9395a8516155485c6c8daa86428125ac($context, $indent, $value);
                $buffer .= $indent . '              </div>
';
                $buffer .= $indent . '          </div>
';
