...
class __MyTemplates_f34629003f1722947409fd7eec2a441e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section00308282818512a7fedddc96bd51d98a($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section00308282818512a7fedddc96bd51d98a(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="recommended-movie">
          ...
          <div class="rm-details">
            ...
            <div class="rm-release-date skeleton">testestesting</div>
          </div>
        </div>
        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '            <div class="rm-release-date skeleton">testestesting</div>
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '        </div>
