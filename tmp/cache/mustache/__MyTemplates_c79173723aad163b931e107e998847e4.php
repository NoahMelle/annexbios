...
class __MyTemplates_c79173723aad163b931e107e998847e4 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6323986cd8e3531d79947e407308bdd6($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '  </div>
';
...
';
    ...
    private function section6323986cd8e3531d79947e407308bdd6(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="recommended-movie">
        <div class="rm-img-container skeleton">
            <img src="" class="rm-img" alt="Movie Poster" />
        </div>
...
';
                $buffer .= $indent . '            <img src="" class="rm-img" alt="Movie Poster" />
';
                $buffer .= $indent . '        </div>
';
