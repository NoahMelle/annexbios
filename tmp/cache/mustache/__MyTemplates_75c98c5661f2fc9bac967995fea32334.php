...
class __MyTemplates_75c98c5661f2fc9bac967995fea32334 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section956ba832abc4b39d3c4abd065d33aa35($context, $indent, $value);
        $buffer .= $indent . '      </div>
';
        $buffer .= $indent . '    </div>
';
...
';
    ...
    private function section956ba832abc4b39d3c4abd065d33aa35(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        <div class="recommended-movie">
          ...
          <div class="rm-details">
            ...
            <div class="rm-release-date skeleton">testestest</div>
          </div>
        </div>
        ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                $buffer .= $indent . '            <div class="rm-release-date skeleton">testestest</div>
';
                $buffer .= $indent . '          </div>
';
                $buffer .= $indent . '        </div>
