...
class __MyTemplates_57558cd9365819fdd8f53d3ca874bb0e extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionBa245c69072c3d6831f1186cd04a9308($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</main>
';
...
';
    ...
    private function sectionBa245c69072c3d6831f1186cd04a9308(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
      ...
      <div class="playing-movie skeleton">
        ...
        <div class="rm-cms">
          <a href="{{ base_url }}filmladder/wijzig/" class="rm-edit">BEWERK</a>
          <a href="{{ base_url }}filmladder/verwijder/" class="rm-delete">VERWIJDER</a>
        </div>
      </div>
      ';
            $result = (string) call_user_func($value, $source, $this->lambdaHelper);
...
';
                ...
                $value = $this->resolveValue($context->find('base_url'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= 'filmladder/wijzig/" class="rm-edit">BEWERK</a>
';
                $buffer .= $indent . '          <a href="';
                $value = $this->resolveValue($context->find('base_url'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $buffer .= 'filmladder/verwijder/" class="rm-delete">VERWIJDER</a>
';
                $buffer .= $indent . '        </div>
';
                $buffer .= $indent . '      </div>
