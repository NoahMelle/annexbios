...
class __MyTemplates_1f300fb091d408634921584d539a5444 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section455ef618429b77aaba6cd3ea9a30b5bb($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function section455ef618429b77aaba6cd3ea9a30b5bb(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="recommended-movie">
                        ...
                        <div class="rm-details">
                            <div class="rm-title skeleton">testestest</div>
...
';
                $buffer .= $indent . '                            <div class="rm-title skeleton">testestest</div>
';
