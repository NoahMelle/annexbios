...
class __MyTemplates_8ade24867d3cee9f889351d7d70840fe extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionD8cd892ec9457fd409e622963e4bcc60($context, $indent, $value);
        $buffer .= $indent . '  </div>
';
        $buffer .= $indent . '</main>
';
    ...
    private function sectionD8cd892ec9457fd409e622963e4bcc60(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    <div class="location">
      ...
      <div class="location-info">
        ...
        <a href="#" class="location-button red">Verwijder Vesteging</a>
...
';
                $buffer .= $indent . '        <a href="#" class="location-button red">Verwijder Vesteging</a>
';
                $buffer .= $indent . '
';
                $buffer .= $indent . '      </div>
