...
class __MyTemplates_7c7422336857ff9dba4a5646a7102002 extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section21a795a74783452635da6e6f1b60da97($context, $indent, $value);
        $buffer .= $indent . '                </div>
';
        $buffer .= $indent . '            </div>
';
...
';
    ...
    private function section21a795a74783452635da6e6f1b60da97(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
            ...
            $source = '
                    <div class="recommended-movie">
                        ...
                        <div class="rm-details">
                            <div class="rm-title skeleton">testestest testestest testestest testestest testestest testestest</div>
...
';
                $buffer .= $indent . '                            <div class="rm-title skeleton">testestest testestest testestest testestest testestest testestest</div>
';
