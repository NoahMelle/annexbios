...
class __MyTemplates_6f66974eb3c4b1bdfce554d27e709dea extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->sectionF316c3f00653670d4a5af0bae0829ed2($context, $indent, $value);
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '</main>
';
...
';
    ...
    private function sectionF316c3f00653670d4a5af0bae0829ed2(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
                $buffer .= $indent . '          <div class="rm-location"></div>
';
                $buffer .= $indent . '        </div>
';
