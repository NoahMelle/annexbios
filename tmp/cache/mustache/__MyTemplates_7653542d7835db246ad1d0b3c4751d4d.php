...
class __MyTemplates_7653542d7835db246ad1d0b3c4751d4d extends Mustache_Template
{
...
';
        ...
        $buffer .= $this->section6162d078f88f2e2eb4de269ff130bc2d($context, $indent, $value);
...
';
    ...
    private function section6162d078f88f2e2eb4de269ff130bc2d(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (is_object($value) && is_callable($value)) {
            $source = '
    <div class="location">
      <img class="location-image" src="{{ image_path }}" alt="foto van de vestiging" />
...
';
                ...
                $buffer .= '" alt="foto van de vestiging" />
';
                $buffer .= $indent . '      <div class="location-info">
';
